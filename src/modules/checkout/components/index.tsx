  ...
  return (
    <Container>
      ...
      <ResumeSectionWrapper>
        ...
        <ResumeSection>
          <BillData isUserBillCompleted={isUserBillCompleted} setIsUserBillCompleted={setIsUserBillCompleted} />
        </ResumeSection>

        <ResumeSection>
          <ResumeTitle title="Pago" hideLink />
          <StripeCheckout moveToNextStep={moveToNextStep} isBillDataFilled={isBillDataFilled} setIsUserBillCompleted={setIsUserBillCompleted} />
        </ResumeSection>
