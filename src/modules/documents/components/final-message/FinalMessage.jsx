...
const ConfirmationTitleContainer = styled.div`
  ...
  opacity: 0 !important;
  box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.4), -5px -5px 15px rgba(255, 255, 255, 0.1);
  ...
  return (
    <>
      <MessageContainer>
        ...
        {children}
        <GreatfulText>Agradecemos muchísimo su confianza. ¡Esperamos verle de nuevo por aquí!</GreatfulText>

        <a href="https://www.autotrafic.es" target="_self" style={{ textDecoration: 'none' }}>
